export const gameFeatures = [
  {
    ...
    description:
      "Our game grabs the latest Cypress prices from trustworthy places on the web. This means your guesses are based on what's happening in the market right now.",
  },
  {
    title: "🤔 Guessing Game",
    description:
      "The game is super easy - you just need to guess whether the Cypress price will be higher or lower after 5 seconds.",
  },
  {
  ...
  },
  {
    title: "🔄 Play Anytime",
    description:
      "You can close your browser and come back anytime. Your score will be saved, and you can pick up where you left off.",
  },
];
