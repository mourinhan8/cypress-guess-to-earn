export const gameFeatures = [
  ...
  },
  {
    title: "💾 Score Saving",
    description:
      "Your scores will be saved in our database, so even if you leave and come back later, your score will still be there.",
  },
  {
    title: "🔄 Play Anytime",
    description:
      "You can close your browser and come back anytime. Your score will be saved.",
  },
  {
    title: "🏆 Rewards",
